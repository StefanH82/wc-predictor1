...
const KO_MATCHES = [
  ...
  {id:"R32_3",group:"KO",stage:"Round 3 of 32",home:"Germany",away:"Paraguay",kickoff:"2026-06-29T22:30:00Z",venue:"Gillette Stadium"},
  ...
  {id:"R32_8",group:"KO",stage:"Round 8 of 32",home:"England",away:"DR Congo",kickoff:"2026-07-01T18:00:00Z",venue:"Estadio Banorte"},
  {id:"R32_9",group:"KO",stage:"Round 9 of 32",home:"Belgium",away:"Senegal",kickoff:"2026-07-01T22:00:00Z",venue:"Lumen Field"},
  {id:"R32_10",group:"KO",stage:"Round 10 of 32",home:"USA",away:"Bosnia & Herzegovina",kickoff:"2026-07-02T02:00:00Z",venue:"Levi's Stadium"},
  {id:"R32_11",group:"KO",stage:"Round 11 of 32",home:"Spain",away:"Austria",kickoff:"2026-07-02T21:00:00Z",venue:"Los Angeles Stadium"},
  {id:"R32_12",group:"KO",stage:"Round 12 of 32",home:"Portugal",away:"Croatia",kickoff:"2026-07-03T01:00:00Z",venue:"Toronto Stadium"},
  {id:"R32_13",group:"KO",stage:"Round 13 of 32",home:"Switzerland",away:"Algeria",kickoff:"2026-07-03T05:00:00Z",venue:"Vancouver Stadium"},
  {id:"R32_14",group:"KO",stage:"Round 14 of 32",home:"Australia",away:"Egypt",kickoff:"2026-07-03T20:00:00Z",venue:"Dallas Stadium"},
  {id:"R32_15",group:"KO",stage:"Round 15 of 32",home:"Argentina",away:"Cape Verde",kickoff:"2026-07-04T00:00:00Z",venue:"Miami Stadium"},
  {id:"R32_16",group:"KO",stage:"Round 16 of 32",home:"Colombia",away:"Ghana",kickoff:"2026-07-04T03:30:00Z",venue:"Kansas Stadium"},
  {id:"R16_1",group:"KO",stage:"Round 1 of 16",home:"Canada",away:"Morocco",kickoff:"2026-07-04T19:00:00Z",venue:"Houston Stadium"},
  {id:"R16_2",group:"KO",stage:"Round 2 of 16",home:"Paraguay",away:"France",kickoff:"2026-07-04T23:00:00Z",venue:"Philadelphia Stadium"},
  {id:"R16_3",group:"KO",stage:"Round 3 of 16",home:"Brazil",away:"Norway",kickoff:"2026-07-05T22:00:00Z",venue:"Houston Stadium"},
  {id:"R16_4",group:"KO",stage:"Round 4 of 16",home:"Mexico",away:"England",kickoff:"2026-07-05T22:00:00Z",venue:"Mexico Stadium"},
  {id:"R16_5",group:"KO",stage:"Round 5 of 16",home:"Portugal",away:"Spain",kickoff:"2026-07-06T21:00:00Z",venue:"Dallas Stadium"},
  {id:"R16_6",group:"KO",stage:"Round 6 of 16",home:"USA",away:"Belgium",kickoff:"2026-07-07T02:00:00Z",venue:"Seattle Stadium"},
  {id:"R16_7",group:"KO",stage:"Round 7 of 16",home:"Argentina",away:"Egypt",kickoff:"2026-07-07T18:00:00Z",venue:"Atlanta Stadium"},
  {id:"R16_8",group:"KO",stage:"Round 8 of 16",home:"Switzerland",away:"Colombia",kickoff:"2026-07-07T22:00:00Z",venue:"Vancouver Stadium"},
  {id:"QF1",group:"KO",stage:"Quarter-Finals",home:"France",away:"Morocco",kickoff:"2026-07-09T22:00:00Z",venue:"Boston Stadium"},
  {id:"QF2",group:"KO",stage:"Quarter-Finals",home:"Spain",away:"Belgium",kickoff:"2026-07-10T21:00:00Z",venue:"Los Angeles Stadium"},
  {id:"QF3",group:"KO",stage:"Quarter-Finals",home:"Norway",away:"England",kickoff:"2026-07-11T23:00:00Z",venue:"Miami Stadium"},
...
const db = {
  ...
  // Save predictions — upsert per match (preserves predictions not in this batch)
  async savePredictions(userId, predictions) {
    ...
    // Delete only the matches we're about to save, then re-insert
    // This avoids wiping predictions not in the current batch
    const matchIds = rows.map(r => r.match_id);

    // Delete only rows for these specific match IDs
    for (const matchId of matchIds) {
      await fetch(
        `${SUPABASE_URL}/rest/v1/predictions?user_id=eq.${userId}&match_id=eq.${matchId}`,
        {
          method: "DELETE",
          headers: {
            "apikey": SUPABASE_ANON,
...
export default function App() {
  ...
  async function submitPredictions() {
    ...
    setSaving(true);
    try {
      // Only save predictions for unlocked matches
      // (the new savePredictions only deletes/replaces matches in this batch,
      //  so predictions for other matches are preserved in the database)
      const toSave = {};
      ...
      if (Object.keys(toSave).length === 0) {
        showToast("No unlocked predictions to save","error");
      ...
      const lb = await db.loadLeaderboard();
      setLeaderboard(lb.map(r => ({ name: r.name, points: r.points || 0, count: r.predictions_count || 0 })));
      showToast(`Saved! ${Object.keys(toSave).length} predictions · ${pts} pts so far`);
